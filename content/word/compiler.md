...
- **[interpreter](/interpreter)**：ソースコードを1行ずつ逐次実行するソフトウェア
...
- [program](/program)：プログラム、コンピュータへの指示をまとめたもの
- [debugger](/debugger)：プログラムのバグを見つけて修正するためのツール

---

## 📖 できればこれも

- [algorithm](/algorithm)：アルゴリズム、問題解決の手順
- [software](/software)：ソフトウェア、コンピュータ上で動作するプログラム
