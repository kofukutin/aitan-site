---
robots: noindex
title: "【discussion】の意味・使い方・例文 ― conversationとの違い【TOEIC英単語】"
description: "discussionの意味・使い方・TOEICでの出題傾向をやさしく解説。例文・クイズ付きでconversationとの違いもわかりやすく学べます。"
word: "discussion"
part_of_speech: "名詞"
difficulty: "2"
tags:
...
<button class="play-audio" onclick="playTTS('discussion')">
...
1. We had a discussion about the new project.  
2. We had a discussion on going to shopping.
...
- **[conversation](/conversation)**：日常的な会話や雑談、テーマが決まっていない話
...
- [debate](/debate)：討論、ディベート（賛否に分かれて意見を戦わせること）
- [negotiation](/negotiation)：交渉（条件や取引について話し合うこと）
