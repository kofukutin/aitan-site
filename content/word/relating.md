...
- **[regarding](/regarding)**：前置詞として「～に関して」と文頭や文中で使う
...
- [concerning](/concerning)：～に関して（前置詞）
- [relevant](/relevant)：関連がある、適切な（形容詞）

---

## 📖 できればこれも

- [related](/related)：関連した、関係のある（形容詞）
- [relative](/relative)：相対的な、比較上の（形容詞）
